...
| **Beijing style** — drawn wild tile | Chinese | `catalogued` | `single-source` | [`01-proto-mahjong/04-chinese-classical/01-shanghai-hong-kong-new-style/02-mainland-regionals/06-beijing-style`](01-proto-mahjong/04-chinese-classical/01-shanghai-hong-kong-new-style/02-mainland-regionals/06-beijing-style/) |
| **Chinese archaic** — c. 1890, Wilkinson | Roots / ancestral | `documented` | `single-source` | [`01-proto-mahjong/01-chinese-archaic`](01-proto-mahjong/01-chinese-archaic/) |
...
| **Chinese classical** — 1920s, 144 tiles | Chinese | `documented` | `conflicting` | [`01-proto-mahjong/04-chinese-classical`](01-proto-mahjong/04-chinese-classical/) |
...
| **Hong Kong Taiwanese** — HKT | Taiwanese | `catalogued` | `unsupported` | [`01-proto-mahjong/04-chinese-classical/01-shanghai-hong-kong-new-style/01-hong-kong-old-style/03-taiwanese-style/01-hong-kong-taiwanese`](01-proto-mahjong/04-chinese-classical/01-shanghai-hong-kong-new-style/01-hong-kong-old-style/03-taiwanese-style/01-hong-kong-taiwanese/) |
| **Houchi rules** — 1952, Amano Daizou | Japanese | `documented` | `single-source` | [`01-proto-mahjong/04-chinese-classical/02-japanese-classical-arushiiaru/01-houchi-rules`](01-proto-mahjong/04-chinese-classical/02-japanese-classical-arushiiaru/01-houchi-rules/) |
...
| **Mahjong Masters Millions** | Modern inventions (not descendants) | `catalogued` | `single-source` | [`02-modern-inventions/03-mahjong-masters-millions`](02-modern-inventions/03-mahjong-masters-millions/) |
...
| **Modern rules** — 1967, ura dora, oka, bazoro | Japanese | `documented` | `single-source` | [`01-proto-mahjong/04-chinese-classical/02-japanese-classical-arushiiaru/01-houchi-rules/01-tokyo-rules/01-modern-rules`](01-proto-mahjong/04-chinese-classical/02-japanese-classical-arushiiaru/01-houchi-rules/01-tokyo-rules/01-modern-rules/) |
| **Nanjing style** — dragons as flowers | Chinese | `catalogued` | `single-source` | [`01-proto-mahjong/04-chinese-classical/01-shanghai-hong-kong-new-style/02-mainland-regionals/07-nanjing-style`](01-proto-mahjong/04-chinese-classical/01-shanghai-hong-kong-new-style/02-mainland-regionals/07-nanjing-style/) |
...
| **NMJL card** — 1937, annual hand list | Western / American | `documented` | `conflicting` | [`01-proto-mahjong/04-chinese-classical/04-babcock-rules/03-regional-us-house-rules/01-nmjl-card`](01-proto-mahjong/04-chinese-classical/04-babcock-rules/03-regional-us-house-rules/01-nmjl-card/) |
...
| **Proto-mahjong** — c. 1870s, rules lost | Roots / ancestral | `lost` | `single-source` | [`01-proto-mahjong`](01-proto-mahjong/) |
...
| **Sanma** — 3-player riichi | Japanese | `catalogued` | `partial` | [`01-proto-mahjong/04-chinese-classical/02-japanese-classical-arushiiaru/01-houchi-rules/01-tokyo-rules/01-modern-rules/02-sanma`](01-proto-mahjong/04-chinese-classical/02-japanese-classical-arushiiaru/01-houchi-rules/01-tokyo-rules/01-modern-rules/02-sanma/) |
| **Shanghai / Hong Kong new style** — 1920s | Chinese | `documented` | `partial` | [`01-proto-mahjong/04-chinese-classical/01-shanghai-hong-kong-new-style`](01-proto-mahjong/04-chinese-classical/01-shanghai-hong-kong-new-style/) |
...
| **Tokyo rules** — 1957, 1-han minimum | Japanese | `documented` | `single-source` | [`01-proto-mahjong/04-chinese-classical/02-japanese-classical-arushiiaru/01-houchi-rules/01-tokyo-rules`](01-proto-mahjong/04-chinese-classical/02-japanese-classical-arushiiaru/01-houchi-rules/01-tokyo-rules/) |
| **Tui Dao Hu** — multiple winners | Chinese | `single-informant` | `partial` | [`01-proto-mahjong/04-chinese-classical/01-shanghai-hong-kong-new-style/02-mainland-regionals/10-tui-dao-hu`](01-proto-mahjong/04-chinese-classical/01-shanghai-hong-kong-new-style/02-mainland-regionals/10-tui-dao-hu/) |
...
| **Western / British Empire style** | Western / American | `documented` | `corroborated` | [`01-proto-mahjong/04-chinese-classical/04-babcock-rules/02-western-british-empire-style`](01-proto-mahjong/04-chinese-classical/04-babcock-rules/02-western-british-empire-style/) |
...
| **Zung Jung** — Alan Kwan, 2000s | Chinese | `documented` | `conflicting` | [`01-proto-mahjong/04-chinese-classical/01-shanghai-hong-kong-new-style/01-hong-kong-old-style/06-zung-jung`](01-proto-mahjong/04-chinese-classical/01-shanghai-hong-kong-new-style/01-hong-kong-old-style/06-zung-jung/) |
